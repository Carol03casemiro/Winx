@extends ('layout')
    ...
    <div class="container text-center">
        <h2 class="mb-4">Pesquisar Winx</h2>
        <form method="Post" action="" class="mb-5">
            <div class="mb-3">
                <label for="inputwinx" class="form-label">Digite Winx:</label>
                <input type="text" class="form-control" id="inputwinx" name="nomeWinx" placeholder="Digite o nome do winx">
            </div>
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Winx</th>
                        <th scope="col">Elemento</th>
                        <th scope="col">Namorado</th>
